 ...
 */
public class Reviews_json_Task extends AsyncTask<String, Void, List<Review>> {

    private final String TAG = "Reviews_json_Task";
    ReviewCallback reviewCallback;


    public Reviews_json_Task(ReviewCallback reviewCallback) {
